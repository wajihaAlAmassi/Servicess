...
import 'package:services_application/presentation/widgets/Inputs/buildSelecetableoption.dart';
import 'package:services_application/presentation/widgets/Inputs/custom_text_field.dart';
import 'package:services_application/presentation/widgets/appear/counter_ranger_packer_widgets.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            CustomNextButton(
              onPressed: () {
                print(
                  'Selected Job Type: ${jobTypeOptions[selectedJobTypeIndex]}',
                );
                print(
                  'Selected Work Space: ${workSpaceOptions[selectedWorkSpaceIndex]}',
                );
              },
              text: "Next",
            ),
