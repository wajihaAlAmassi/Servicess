...
import 'package:servicess/presentation/widgets/Cards/content_card_widget.dart';
import 'package:servicess/presentation/widgets/appear/custom_app_bar.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const Positioned(left: 20, top: 120, child: SearchBarWidget()),
        ],
      ),
      ...
      // bottomNavigationBar: 
        // CustomBottomNav(cureentIndex: 2, userType: 'Provider',)
