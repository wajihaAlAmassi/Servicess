...
import 'package:servicess/presentation/Pages/allusers/requester_dashboard.dart';
        ...
        if (state is AuthSuccess) {
          ...
          if (userType == 'provider') {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => RequesterDashboard(),
              ),
            );
            ...
            child: Column(
              ...
              children: [
                ...
                const Row(
                  children: [
                    Expanded(
                      child: Divider(color: AppColors.lightText),
                    ),
                    Padding(
